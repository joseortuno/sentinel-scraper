...
describe("Scraper - Scraping tool", () => {
  ...
  //   }).to.throw(
  //     ReferenceError,
  //     "The method select need parameters: selector and expression."
  //   );
  // });
  ...
  //   }).to.throw(
  //     TypeError,
  //     "Expression expect a function. true is a boolean."
  //   );
  // });
  ...
  //   }).to.throw(
  //     ReferenceError,
  //     "The static method for need parameters: urls and expression."
  //   );
  // });
  ...
  //   }).to.throw(
  //     ReferenceError,
  //     "The url to concatenate is not a url format."
  //   );
  // });
});
